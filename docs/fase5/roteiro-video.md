...
| 4:20–4:45 | Terminal | `./mvnw test` — **37** testes verdes (fluxo ponta a ponta, isolamento entre pacientes, RBAC, guardrail de não-prescrição e o ciclo da medicação). Diga **37**, que é o que o terminal mostra e o que a documentação afirma — e **122 no projeto inteiro**. |
