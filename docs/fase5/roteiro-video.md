...
| 4:20–4:45 | Terminal | `./mvnw test` — **18** testes verdes (fluxo ponta a ponta, isolamento entre pacientes, RBAC, guardrail de não-prescrição e o ciclo da medicação). Diga **18**, que é o que o terminal mostra e o que a documentação afirma — e **61 no projeto inteiro**. |
